    ...
    return (
        <div className="min-h-screen bg-white text-slate-900 py-20 px-6">
            <div className="max-w-3xl mx-auto prose prose-slate prose-headings:font-bold prose-headings:text-slate-900 prose-p:text-slate-600 prose-ul:text-slate-600">
                <h1 className="text-3xl font-extrabold mb-8">Política de Privacidade – Creatye</h1>

                <p>A Creatye é uma plataforma de automação para Instagram que permite a gestão de mensagens, comentários e interações de forma automatizada.</p>
